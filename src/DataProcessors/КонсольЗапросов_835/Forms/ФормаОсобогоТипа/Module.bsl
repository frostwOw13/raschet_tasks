...
Процедура Инициализировать() Экспорт
	...
	ТипПараметраСтрока = мСтруктураТипов.Неопределено.ИмяТипа;
...
Процедура Завершить(Команда)
	ВладелецФормы.Асинхрон_ФормаОсобогоТипа(ЗавершитьРедактирование(мСтруктураТипов));
	Закрыть();
КонецПроцедуры
...
Функция ЗавершитьРедактирование(СтруктураТипов)
	...
	Если ТипПараметраСтрока = СтруктураТипов.Неопределено.Тип Тогда
		
	ИначеЕсли ТипПараметраСтрока = СтруктураТипов.МоментВремени.ИмяТипа Тогда
		Если ЗначениеЗаполнено(МоментВремениСсылка) Тогда
			Результат = МоментВремениСсылка.МоментВремени();
		КонецЕсли;
	ИначеЕсли ТипПараметраСтрока = СтруктураТипов.Граница.ИмяТипа Тогда
		Если ЗначениеЗаполнено(ГраницаЗначение) Тогда
			...
			КонецЕсли;
		КонецЕсли;
	//ИначеЕсли ТипПараметраСтрока = СтруктураТипов.ТаблицаЗначений.ИмяТипа Тогда
